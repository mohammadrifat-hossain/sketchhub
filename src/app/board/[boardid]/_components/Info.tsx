      ...
      <Hint label="Go to boards" side="bottom" sideOffset={10}>
        <Button className="px-2" variant={"board"} asChild>
          <Link href={"/"} className="w-full">
            ...
            <span
              className={cn(
                "font-semibold text-xl mx-2 text-black ",
                font.className
              )}
            >
              SketchHub
...
export const InfoSkeleton = () => {
  return (
    <div className="absolute top-2 bg-white left-2 rounded-md px-1.5 h-12 flex items-center shadow-md w-[300px] animate-pulse" />
  );
};
