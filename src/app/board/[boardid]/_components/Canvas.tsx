...
export const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const onPointerMove = useMutation(
    ...
    [canvasState, camera, resizeSelectedLayer, translateSelectedLayers, continueDrawing, startMultiSelection, updateSelectionNet]
  );
  ...
  const onPointerUp = useMutation(
    ...
    [camera, canvasState, history, setCanvasState, insertLayer, unselectLayers, insertPath]
  );
  ...
  const onResizeHandlePointerDown = useCallback((corner: Side, initialBounce: XYHW)=>{
